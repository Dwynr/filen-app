...
export function uploadChunk(uuid, queryParams, data, tries, maxTries, callback){
					...
					fileReader.onload = async () => {
						...
						workers.encryptData(uuid, thisIndex, key, arrayBuffer, (encrypted) => {
							...
							this.uploadChunk(uuid, queryParams, blob, 0, 10, (err, res) => {
								...
								if(typeof window.customVariables.uploads[uuid].loaded !== "undefined"){
